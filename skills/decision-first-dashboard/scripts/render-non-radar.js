...
@media(max-width:620px){.dashboard-shell{width:calc(100vw - 24px);padding-top:28px}.synthesis-card{min-height:540px}.signal-lead{min-height:210px;padding:34px 24px}.signal-lead strong{font-size:48px}.signal-support-grid{grid-template-columns:1fr 1fr}.supporting-context-rail{grid-template-columns:1fr 1fr}}
`;
