...
function enhanceNoScoreSvg(markup, data) {
  const legacyRadarBlock = /<circle cx="698" cy="464" r="188"[\s\S]*?<path d="M698 464[^"]*" fill="none" stroke="[^"]+" stroke-width="[^"]+"\/>/;
  markup = markup.replace(legacyRadarBlock, svgRadar(data));
  markup = markup.replaceAll('r="94" fill="#ffffff"', 'r="58" fill="#ffffff"');
  markup = markup.replaceAll('r="82" fill="#f7f4ff"', 'r="50" fill="#f7f4ff"');
  markup = markup.replace('font-size="29" font-weight="760" text-anchor="middle">', 'font-size="18" font-weight="760" text-anchor="middle">');
  markup = markup.replace('font-size="14" text-anchor="middle">Target unknown', 'font-size="11" text-anchor="middle">Target unknown');
...
${RADAR_BASE_CSS}.score-center .score-component{z-index:3}.score-center .synthesis-core{width:118px;height:118px;z-index:4}.score-center .synthesis-core strong{font-size:40px}.score-component strong{font-size:24px}`;

const NO_SCORE_RADAR_CSS = `
${RADAR_BASE_CSS}.synthesis-card .radar-dimension{position:absolute;width:142px;text-align:center;z-index:3;transform:translate(-50%,-50%)}.synthesis-card .radar-dimension strong{display:block;color:var(--accent);font-size:24px;line-height:1;letter-spacing:-.025em}.synthesis-card .radar-dimension span{display:block;margin-top:9px;font-weight:700;font-size:13px}.synthesis-card .synthesis-core{width:118px;height:118px;z-index:4}.synthesis-card .synthesis-core strong{font-size:18px;line-height:1.05}.synthesis-card .synthesis-core span{margin-top:8px;font-size:11px}`;
